...
public class Command {
  ...
  private byte[] getBytes(Object object) {
    ...
    if (object == null) {
      ...
      argument = ((ByteBuffer) object).array();
  ...
  public static void writeDirect(ByteBuffer os, Object name, Object object1, Object object2, Object object3, Object[] objects) throws IOException {
    int others = (object1 == null ? 0 : 1) + (object2 == null ? 0 : 1) +
            (object3 == null ? 0 : 1) + (name == null ? 0 : 1);
    int length = objects == null ? 0 : objects.length;
    os.put(ARGS_PREFIX);
    os.put(numToBytes(length + others, true));
  ...
  private static void writeObject(ByteBuffer os, Object object) throws IOException {
    byte[] argument;
    if (object == null) {
      argument = EMPTY_BYTES;
    } else if (object instanceof byte[]) {
      ...
      writeArgument(os, (ByteBuffer) object);
      return;
    } else if (object instanceof String) {
      argument = ((String) object).getBytes(Charsets.UTF_8);
    } else {
  ...
  private static void writeArgument(ByteBuffer os, byte[] argument) throws IOException {
    os.put(BYTES_PREFIX);
    os.put(numToBytes(argument.length, true));
    os.put(argument);
    os.put(CRLF);
  }

  private static void writeArgument(ByteBuffer os, ByteBuffer argument) throws IOException {
    os.put(BYTES_PREFIX);
    os.put(numToBytes(argument.remaining(), true));
    os.put(argument);
    os.put(CRLF);
  }
